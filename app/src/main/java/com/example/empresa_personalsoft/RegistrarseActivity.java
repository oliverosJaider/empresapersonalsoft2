...
public class RegistrarseActivity extends AppCompatActivity implements Response.Listener<JSONObject>,Response.ErrorListener{
    ...
    public void Consultar(View view){
         ...
         if (usuario.isEmpty()){
            ...
            url = "http://172.16.60.255:80/WebServices/consulta.php?usr=" + usuario;
    ...
    public void modificar(View view){
        ...
        if (usuario.isEmpty() || nombre.isEmpty() || correo.isEmpty() || clave.isEmpty()){
            ...
            url = "http://172.16.60.255:80/WebServices/actualiza.php";
        }
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>()
                {
                    ...
                    public void onResponse(String response) {
                        Limpiar_campos();
                        Toast.makeText(getApplicationContext(), "Registro modificado !", Toast.LENGTH_LONG).show();
                    }
                },
                new Response.ErrorListener()
                {
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(getApplicationContext(), "no fue posible modificarlo!", Toast.LENGTH_LONG).show();
                    }
                }
        ) {
            @Override
    ...
    public void Anular(View view){
            ...
            if (usuario.isEmpty()){
                ...
                url = "http://172.16.60.255:80/Empresa6/anula.php";
                StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                        new Response.Listener<String>() {
                            @Override
                            public void onResponse(String response) {
    ...
    public void Adicionar_usuario(View view){
        ...
        if (usuario.isEmpty() || nombre.isEmpty() || correo.isEmpty() || clave.isEmpty()){
            ...
            jetusuario.requestFocus();
                ...
                url = "http://172.16.60.255:80/WebServices/registrocorreo.php";
            }
            StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                    new Response.Listener<String>()
                    {
